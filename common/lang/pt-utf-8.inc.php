...
define('LABEL_QueBuscar',"que buscar?");
...
define('LABEL_CFG_MAX_TREE_DEEP','Máximo nivel de profundidade na árvore de assuntos para visualização');
...
define('LABEL_CFG_NUM_SHOW_TERMSxSTATUS','quantidade de temros para visualização de listas segundo estados');
...
v1.5
*/
define("LABEL_relationEditor","editor de relações");
...
define('LABEL_update1_6x1_7','Atualizar (1.6 -> 1.7)');
